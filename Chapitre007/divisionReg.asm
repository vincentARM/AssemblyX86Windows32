...
Main:
    ...
    mov eax,53               ; division simple non signée
    mov ebx,10
    mov edx,0                ; à mettre car risque de problème 
    div ebx
    ...
    mov eax,-10002           ; test division nombre négatif
    mov edx,-1
    mov ebx,50
