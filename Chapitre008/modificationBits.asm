;---programme modificationsBits.asm 
; conversion d'un registre en base 2
; test de bt btc btr bts 
...
Main:
    ...
    mov eax,0b01100
    bt  eax,3                  ;met le bit 3 (en 4ième position) dans carry
    call verifierIndicateurs
    btc eax,1                  ;met le bit 1 (en 2ième position) dans carry et l'inverse
    call verifierIndicateurs
    push eax
    push sZoneConv
    call conversion2
    ...
    btr eax,2                    ; met le bit 2 dans carry et le met à zéro
    call verifierIndicateurs
    push eax
    push sZoneConv
    call conversion2
    ...
    bts eax,4                    ; met le bit 4 dans carry et le met à un
    call verifierIndicateurs
    push eax
    push sZoneConv
    call conversion2
    ...
    mov eax,-1                     ; pour verifier son évolution
    mov ebx,0b1010000000
    bsf eax,ebx                    ; cherche le bit à un le plus à droite de ebx
    push eax                       ; et met sa position dans eax
    push sZoneConv
    call conversion10S
    push szMsgReg
    call afficherConsole
    ...
    mov eax,-1                     ; pour verifier son évolution
    mov ebx,0b1010000000
    bsr eax,ebx                    ; cherche le bit à un le plus à gauche de ebx
    push eax                       ; et met sa position dans eax
    push sZoneConv
    call conversion10S
    push szMsgReg
