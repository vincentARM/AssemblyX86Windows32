;---programme operationsBinaire.asm 
; conversion d'un registre en base 2
; test de and or xor not et neg
...
afficherMessage:
    ...
    pushf
    mov edx, [ebp + 8]    ; recup de la valeur à afficher
    push 0                ; uType = MB_OK
